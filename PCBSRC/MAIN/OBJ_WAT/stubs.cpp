...
int getconfbyrec(unsigned rec, void *cnamesidx) {
    (void)rec; (void)cnamesidx;
    return -1;
}
unsigned findconfbyname(char *name, void *cnamesidx) {
    (void)name; (void)cnamesidx;
    return 0;
}

/* Font — return default */
int getfont(void) { return 0; }

/* File existence check */
int checkexistence(char *path, char flag1, char *buf, bool flag2) {
    (void)path; (void)flag1; (void)buf; (void)flag2;
    return 0;
}

/* User input */
int inputline(int a, int b, int c, int d, char *e, char *f, int g, int h) {
    (void)a; (void)b; (void)c; (void)d; (void)e; (void)f; (void)g; (void)h;
    return 0;
}
void inputextend(int a, int b, int c, int d, char *e, char *f, int g, int h) {
    (void)a; (void)b; (void)c; (void)d; (void)e; (void)f; (void)g; (void)h;
}


/* PCBFILER: archive viewer stub */
extern "C" int ARCV_(void) { return 0; }

/* PCBFILER: DOS DTA (ffblk) */
#include <dos.h>
