...
void  editdirclass::loadrecords(DOSFILE *File) {
  DirListType2  Buffer;
  DirListType   Rec;
...
void  editdirclass::saverecords(DOSFILE *File) {
  long          X;
  DirListType2  Buffer;
  DirListType  *p;
...
void  editdirclass::displayrecord(long RecNum, int LineNo, void *Rec) {
  DirListType *p;
  char         Temp[10];
...
static void near  displaydirhead(int GroupNum) {
  switch (GroupNum) {
...
void  editdirclass::showheaders(void) {
...
void  editdirclass::showfooters(void) {
...
void  editdirclass::handlekeys(void *Rec) {
  if (Mode == SHOWDIRONLY) {
    switch (KeyFlags) {
...
void  editdirclass::editrecord(void *Rec) {
...
void  editdirlist(unsigned BoardNumber, unsigned DirNumber, bool GetArea, bool PromptForConf) {
  int          Code;
  char        *Name;
