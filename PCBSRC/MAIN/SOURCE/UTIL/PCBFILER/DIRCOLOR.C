...
static void near  setatt3(int X1, int Y1, int X2, int Y2, int ColorNum) {
  int X;
  int Y;
...
static void near  movepointer(int Ch, int Top, int Bot, int Lft, int Rht, int *X, int *Y) {
  int X1,Y1;
...
static void near  drawpalette(void) {
  int ColorNum;
  int Back;
  int Loc;
  int Y;
...
static void near  changedircolors(int CursorX, int CursorY) {
  char Ch;
  bool Ext;
  int  ColorNum;
  int  X;
...
static void near  instructcolors(void) {
  char Ch;
  savescrntype ScrnBuf;
