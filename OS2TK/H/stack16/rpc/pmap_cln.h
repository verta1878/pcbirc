...
/*                                                                     */
/********************************************************copyrite.xmc***/
#ifndef __PMAP_CLN_32H
#define __PMAP_CLN_32H
...
extern bool_t           pmap_set(u_long, u_long, u_long, u_short);
extern bool_t           pmap_unset(u_long,u_long);
extern u_short          pmap_getport(struct sockaddr_in *, u_long, u_long, u_int);   /**** OJAN 11/15/95 ****/
extern struct pmaplist  *pmap_getmaps(struct sockaddr_in *);
enum clnt_stat          pmap_rmtcall(struct sockaddr_in *, u_long, u_long, u_long,
                                     xdrproc_t, caddr_t, xdrproc_t, caddr_t,
                                     struct timeval, u_long *);
enum clnt_stat          clnt_broadcast(u_long, u_long, u_long, xdrproc_t, caddr_t,
