...
static void _NEAR_ LIBENTRY initializecontrols(void) {
  ...
  #ifndef PCB_DEMO
    Status.FoundCrc += (long) collect() << 8;
  #endif
  ...
  #ifndef PCB_DEMO
    Status.FoundCrc += (long) collect() << 16;
  #endif
  ...
  #ifndef PCB_DEMO
    Status.FoundCrc += (long) collect() << 24;
  #endif
}
...
void LIBENTRY initnontransient(void) {
  ...
  #ifndef __OS2__
    KbdStatus  = (char far *) MK_FP(0x40,0x17);
  #endif
