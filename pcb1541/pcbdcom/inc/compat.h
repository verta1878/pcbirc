...
# define PCBCOMM_ES  _es
# define PCBCOMM_DI  _di
# define PCBCOMM_SI  _si
# define PCBCOMM_MK_FP(seg,ofs)  MK_FP((seg),(ofs))
# define PCBCOMM_FAR_PTR(seg,ofs)  ((unsigned char __far *)MK_FP((seg),(ofs)))
...
# define PCBCOMM_ES  es
# define PCBCOMM_DI  di
# define PCBCOMM_SI  si
# define PCBCOMM_MK_FP(seg,ofs)  MK_FP((seg),(ofs))
# define PCBCOMM_FAR_PTR(seg,ofs)  ((unsigned char far *)MK_FP((seg),(ofs)))
# define PCBCOMM_UNUSED_REGS \
...
# endif
# define PCBCOMM_MK_FP(seg,ofs)  MK_FP((seg),(ofs))
# define PCBCOMM_FAR_PTR(seg,ofs)  ((unsigned char _far *)MK_FP((seg),(ofs)))
# define PCBCOMM_UNUSED_REGS \
    (void)_bp; (void)_si; (void)_di; (void)_es; (void)_ds; \
    (void)_sp; (void)_ip; (void)_cs; (void)_flags
