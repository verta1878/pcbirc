@echo off
rem ============================================================================
rem  pcbirc cleanup -- v1.6 -> v1.6.4 reorganization
rem
rem  Removes stale directories from the v1.6.0/v1.6.1/v1.6.2 layout that got
rem  consolidated into their final v1.6.3/v1.6.4 homes:
rem
...
echo       (v1.6.3 for target/, v1.6.4 for archivers/) then re-run this.
echo    2. Commit + push via GitHub Desktop:
echo         git add -A
echo         git commit -m "cleanup: remove stale dirs from v1.6 reorg"
echo.
pause
