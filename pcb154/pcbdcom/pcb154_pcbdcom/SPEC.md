...
- `BOCA16` — Boca BB-1004/1008/2016 dumb multi-port (shared IRQ)
...
Card types deferred to v2 or v3:
- `ARNET_SPP` — Arnet SmartPort Plus (no free driver — user supplies
  firmware image, we probe based on published register spec)
...
**v1.1 is code-complete as of 2026-08-30.** All 7 backends have full
