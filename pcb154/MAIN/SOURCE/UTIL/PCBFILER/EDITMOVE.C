...
void  editmovesclass::sortrecords(void) {
  long SortBuf[1024];
...
int  readonemove(DOSFILE *File, movestype *Rec) {
  char Temp[80];
...
void  editmovesclass::loadrecords(DOSFILE *File) {
  movestype  Rec;
...
int  writeonemove(DOSFILE *File, unsigned SrceCnf, unsigned SrceDir, char *Name, unsigned TargetCnf, unsigned TargetDir, char *FileDate, unsigned Days, char CopyMove) {
  char Temp[80];
...
void  editmovesclass::saverecords(DOSFILE *File) {
  long        X;
  movestype  *p;
...
void  editmovesclass::displayrecord(long RecNum, int LineNo, void *Rec) {
  movestype *p;
  char       FileDate[9];
  char       MoveDate[9];
  char       Temp[20];
...
void  editmovesclass::showheaders(void) {
...
void  editmovesclass::showfooters(void) {
...
void  editmovesclass::handlekeys(void *Rec) {
...
void  editmovesclass::editrecord(void *Rec) {
...
long  loadmoves(editmovestype Action) {
