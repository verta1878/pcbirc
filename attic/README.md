# attic — retired working artifacts



Working artifacts kept for reference or recovery. Not part of the

build system; not shipped in releases.
...
Nothing here is authoritative. See the live tree for the current
