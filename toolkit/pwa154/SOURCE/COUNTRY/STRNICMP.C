...
EXTERN_C int strnicmp(const char *str1, const char *str2, size_t maxlen) {
#ifdef __OS2__
  int dif;
...
nci_finalDif:
asm     cmp     al, dl              /* compare after conversion */
asm     je      nci_nextCh
...
*/
asm     sub     ax, dx  /* Get the result. Note: AH & DH are still zero */
